...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RunningNumber = __webpack_require__(160);

	var _RunningNumber2 = _interopRequireDefault(_RunningNumber);
	...
	_reactDom2.default.render(_react2.default.createElement(TestRunningNumber, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RunningNumber = function (_React$Component) {
		_inherits(RunningNumber, _React$Component);

		function RunningNumber() {
			_classCallCheck(this, RunningNumber);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(RunningNumber).apply(this, arguments));
		}

		_createClass(RunningNumber, [{
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement('span', { className: this.props.rnStyle });
			}
		}]);
	...
	RunningNumber.propTypes = {
		...
		rnStyle: _react2.default.PropTypes.string,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".my-running-number {\n\tfont-size: 40px;\n    color: blueviolet;\n}\n", ""]);
